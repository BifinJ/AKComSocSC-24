  ...
  return (
    <section id="About" className="bg-c1 w-dvw min-h-dvh py-8 lg:py-24 px-5 lg:px-32 flex flex-col items-center justify-center text-center">
      ...
      <p className=" text-cwhite font-open text-sm md:text-base font-normal mt-8 text-justify leading-relaxed lg:px-32">
        The All Kerala Communications Society Student Congress (AKComSocSC) is a prestigious annual event organized under the banner of the IEEE Communications Society Kerala Chapter(ComSoc KC). This flagship event serves as a vibrant platform for students, researchers, and industry professionals across Kerala to come together, foster collaboration, and fuel their passion for communication technologies.
        AKComSocSC is more than just a conclave—it&apos;s an experience. With a rich lineup of hands-on workshops, enlightening talk sessions and some cultural fun, attendees will have the unique opportunity to dive deep into the latest advancements in communications technology and have a time of their lives.
        The event is designed to be a melting pot of ideas, offering attendees the chance to network with peers, engage with industrial experts, and explore emerging trends in the ever-evolving field of communications. It&apos;s not just about learning—it&apos;s about connecting, collaborating, and being inspired to push boundaries.
      </p>
      <div className="relative w-full h-fit lg:h-[460px] flex items-center flex-col md:flex-row px-0 lg:px-32 mt-8 text-cwhite">
        ...
        <div className=" w-full lg:w-1/2 h-full flex flex-col items-center justify-between p-2 md:p-5 pl-0 md:pl-7">
          ...
          <p className=" font-normal text-sm md:text-lg text-justify md:pb-6">The mission of the All Kerala Communications Society Student Conclave (AKComSocSC) is to inspire and empower students to innovate and contribute to the ever-evolving field of communication technology. The conclave fosters creativity, promotes awareness of cybersecurity challenges, and emphasizes the development of resilient communication systems for disaster management and emergencies. By highlighting the importance of modern and alternative communication tools, AKComSocSC aims to equip students with the skills and knowledge needed to shape a secure, connected, and technologically advanced future.</p>
        </div>
      </div>
      <AboutCard />
    </section>
