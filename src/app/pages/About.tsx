...
export default function About() {
  return (
    <section className="w-dvw min-h-dvh py-8 lg:py-24 px-5 lg:px-32 flex flex-col items-center justify-center text-center">
      <SectionHeading heading="About Us"/>
      <p className=" font-open text-sm md:text-base font-normal mt-8 ">
